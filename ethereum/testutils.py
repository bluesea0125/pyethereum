...
def isNot0x(s):
    if isinstance(s,bytes):
        return normalize_hex(s).rstrip(b'0') != b'0x'
    elif isinstance(s,str):
        return normalize_hex(s).rstrip('0') != '0x'
    else:
        return False
...
def compare_post_states(shouldbe, reallyis):
    ...
    for k in shouldbe:
        bytekey = eliminate0x(k).encode()
        if bytekey not in reallyis:
            r = {"nonce": 0, "balance": 0, "code": b"0x", "storage": {}}
        else:
            r = acct_standard_form(reallyis[bytekey])
...
def eliminate0x(s):
    if len(s) > 2 and s[:2] in ('0x',b'0x'):
        return s[2:]
    return s

def decode_hex(s):
    from rlp.utils import decode_hex as dehex
    return dehex(eliminate0x(s))
...
if __name__ == "__main__":
    testdata={'out': '0x', 'post': {'0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6': {'storage': {'0x00': '0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe'}, 'code': '0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01600055', 'balance': '0x0de0b6b3a7640000', 'nonce': '0x00'}}, 'gas': '0x013874', 'logs': '0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347', 'exec': {'code': '0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01600055', 'data': '0x', 'origin': '0xcd1722f2947def4cf144679da39c4c32bdc35681', 'gasPrice': '0x5af3107a4000', 'address': '0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6', 'caller': '0xcd1722f2947def4cf144679da39c4c32bdc35681', 'gas': '0x0186a0', 'value': '0x0de0b6b3a7640000'}, 'callcreates': [], 'pre': {'0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6': {'storage': {}, 'code': '0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01600055', 'balance': '0x0de0b6b3a7640000', 'nonce': '0x00'}}, 'env': {'currentDifficulty': '0x0100', 'currentNumber': '0x00', 'currentCoinbase': '0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba', 'currentGasLimit': '0x0f4240', 'currentTimestamp': '0x01'}, '_info': {'source': '/src/VMTestsFiller/vmArithmeticTest/add0Filler.json', 'filledwith': 'cpp-1.3.0+commit.70ba1a56.Linux.g++', 'comment': ''}}
    check_vm_test(testdata)